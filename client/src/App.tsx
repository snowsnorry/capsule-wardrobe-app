...
function App() {
  ...
  return (
    <AppPresentation
      model={buildAppPresentationModel({
        actions: {
          ...handlers,
          onAddPasskey: () => {
            void handleAddPasskeyFromPrompt();
          },
          onClearError: () =>
            setStatus((current) => ({ ...current, error: "" })),
          onClearShareRoute: clearShareRoute,
          onCloseSignOutConfirm: () => setIsSignOutConfirmOpen(false),
          onDismissPasskey: dismissPasskeyPrompt,
          ...
          openSearchDialog: () =>
            capsuleSidebarActionsRef.current?.openSearchDialog(),
        },
        handlers: {
          ...
          onCancelRegenerationSelection:
            handlers.handleCancelRegenerationSelection,
        ...
        notifications: {
          notificationOpen: notificationPrompt.open,
          passkeyPrompt,
        },
        options: {
          audienceOptions,
