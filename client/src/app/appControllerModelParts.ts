...
export function buildActions(input: ControllerModelInput) {
...
export function buildHandlers(handlers: ReturnType<typeof useAppHandlers>) {
  return {
...
export function buildLayout(input: ControllerModelInput) {
  const state = input.appState;
...
export function buildNotifications(input: ControllerModelInput) {
  return {
...
export function buildSession(state: ReturnType<typeof useAppState>) {
  return {
    code: state.code,
    email: state.email,
...
export function buildShare(input: ControllerModelInput) {
  return {
...
export function buildView(input: ControllerModelInput) {
  const state = input.appState;
...
export type ControllerModelActions = ReturnType<typeof buildActions>;
export type ControllerModelHandlers = ReturnType<typeof buildHandlers>;
export type ControllerModelLayout = ReturnType<typeof buildLayout>;
export type ControllerModelNotifications = ReturnType<
  typeof buildNotifications
>;
export type ControllerModelOptions = ReturnType<typeof buildOptions>;
export type ControllerModelSession = ReturnType<typeof buildSession>;
export type ControllerModelShare = ReturnType<typeof buildShare>;
export type ControllerModelView = ReturnType<typeof buildView>;
