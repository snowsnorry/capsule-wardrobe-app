...
function makeProps(overrides: Record<string, unknown> = {}) {
  return {
    ...
    isOutfitImagePending: false,
    isOutfitReportPending: false,
    ...
    activeOutfitMeta: { id: "outfit-1", name: "Weekend", status: "new" },
    ...
    onCreateOutfit: vi.fn(() => Promise.resolve()),
    ...
    onDeleteOutfitImage: vi.fn(() => Promise.resolve()),
    onDeleteOutfitReport: vi.fn(() => Promise.resolve()),
    ...
    onGenerateOutfitImage: vi.fn(() => Promise.resolve()),
    onGenerateOutfitReport: vi.fn(() => Promise.resolve()),
    ...
    onOpenOutfit: vi.fn(() => Promise.resolve()),
    ...
    onReplaceOutfitItems: vi.fn(() => Promise.resolve()),
    onRemoveFromPersonalItems: vi.fn(() => Promise.resolve()),
    onSaveToPersonalItems: vi.fn(() => Promise.resolve()),
