...
import { SearchScreenDesktop, SearchScreenMobile } from "./searchScreen/SearchScreenLayout";
...
function SearchScreen({
  ...
  const search = useSearchScreenState({ initialQuery, autoOpenProductDetail, isMobile, locale, t });
