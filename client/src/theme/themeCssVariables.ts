...
function createThemeCssVariables(mode: ThemeMode) {
  ...
  return {
    ...
    "--cw-color-launcher-border": tokens.launcherBorder,
    "--cw-color-launcher-icon": tokens.launcherIcon,
    "--cw-color-launcher-ink": tokens.launcherInk,
    "--cw-color-notification-icon": tokens.notificationIcon,
    "--cw-color-notification-action-hover": tokens.notificationActionHover,
    "--cw-gradient-launcher": tokens.launcherBackground,
    ...
    "--cw-shadow-launcher": tokens.launcherShadow,
