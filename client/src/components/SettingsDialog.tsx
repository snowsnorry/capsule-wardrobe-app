...
function useSettingsPasskeys({
  ...
  return { passkeys, isPasskeyLoading, passkeyToDelete, setPasskeyToDelete, handleAddPasskey, handleDeletePasskey, closePasskeyDelete };
}
...
function SettingsDialog({
  ...
  const draftState = useSettingsDraftState({ open, settings, onClose, onSave, t });
  const passkeyState = useSettingsPasskeys({ open, setError: draftState.setError, t });
