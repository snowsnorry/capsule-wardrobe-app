...
- `db/` — split database modules for auth, schema, passkeys, profiles, capsule data, wardrobe, personal item reports, search, liked items, product lookup, and product options
