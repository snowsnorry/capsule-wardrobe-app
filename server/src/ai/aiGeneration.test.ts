...
function createWardrobeRows() {
  return [
    { id: "top-1", url: "https://example.com/top", name: "Top", category: "top", image_url: "https://example.com/top.jpg", embedding: [1] },
    { id: "bottom-1", url: "https://example.com/bottom", name: "Bottom", category: "bottom", image_url: "https://example.com/bottom.jpg", embedding: [1] },
    { id: "bag-1", url: "https://example.com/bag", name: "Bag", category: "bag", image_url: "https://example.com/bag.jpg", embedding: [1] }
  ];
}
...
function createBaseDeps(overrides = {}) {
  return {
    ...
    buildCapsuleWardrobeSqlParamsImpl: (_profile, promptEmbeddings, categories) => ({ promptEmbeddings, categories }),
