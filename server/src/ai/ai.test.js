...
test("enforceCategoryCounts keeps legacy category fill behavior when style and color are not provided", () => {
  const balancedItems = enforceCategoryCounts(
    [],
    [
      { id: "top-1", category: "top", style: ["minimalistic"], color_base: ["red"], is_neutral: false },
      { id: "top-2", category: "top", style: ["classic"], color_base: ["blue"], is_neutral: false }
    ],
    {
      top: 2
    }
