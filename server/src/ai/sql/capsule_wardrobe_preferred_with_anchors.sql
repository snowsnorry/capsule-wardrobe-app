  ...
  CROSS JOIN LATERAL (
    ...
    scored AS (
      SELECT
        ...
        (params.color IS NOT NULL AND params.color != '' AND params.color = ANY(COALESCE(candidate_items.color_base, ARRAY[]::text[]))) AS is_color_match,
