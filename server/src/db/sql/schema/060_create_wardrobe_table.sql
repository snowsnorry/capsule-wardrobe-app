create table if not exists wardrobe (
  ...
  audience text null,
  category text null,
  season text[] null default '{}'::text[],
  formality_level text[] null default '{}'::text[],
  style text[] null default '{}'::text[],
  occasions text[] null default '{}'::text[],
  color_base text[] null default '{}'::text[],
  pattern text null,
  finish text null,
