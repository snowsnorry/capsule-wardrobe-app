...
const en = {
  ...
  myWardrobe: {
    ...
    urlUploadDialog: {
      title: "Upload product URLs",
      body: "Add product page links from online stores. Each accepted product becomes an uploaded wardrobe item.",
      fieldLabel: "Product URL {index}",
      placeholder: "https://shop.example.com/product",
      helperText: "Use a product page URL starting with http:// or https://.",
