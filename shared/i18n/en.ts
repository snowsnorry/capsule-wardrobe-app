...
const en = {
  ...
  wardrobe: {
    ...
    uploadUrl: "Upload image URL",
    analyzePersonalItems: "Analyze",
    regenerateReport: "Regenerate report",
    ...
    reportTitle: "Personal items report",
    reportOpenMenu: "Open report actions",
    reportGenerating: "Generating Personal items report",
    reportOutdated: "Report may be outdated",
    reportShowDetails: "Show details",
    reportHideDetails: "Hide details",
    reportScores: "Scores",
    ...
    reportOutfitReadiness: "Outfit readiness",
    reportVersatility: "Versatility",
    reportStyleProfile: "Style profile",
    reportSeasonality: "Seasonality",
    reportColorAnalysis: "Color analysis",
    reportEfficiency: "Efficiency",
    reportStrengths: "Strengths",
    reportIssues: "Issues",
    reportIssueSuggestionLabel: "Suggestion:",
    reportSuggestions: "Suggestions",
    reportConfidence: "Confidence",
    reportScoreCoverage: "Coverage",
    reportScoreOutfitReadiness: "Outfit readiness",
    reportScoreVersatility: "Versatility",
    reportScoreSeasonality: "Seasonality",
    reportScoreStyleClarity: "Style clarity",
    reportScoreColorHarmony: "Color harmony",
    reportScoreEfficiency: "Efficiency",
    reportOverallScore: "Overall score",
    reportDetectedCategoryBalance: "Detected category balance",
    reportDominantStyles: "Dominant styles",
    reportDominantSeasons: "Dominant seasons",
    reportDominantFormalityLevels: "Dominant formality levels",
    reportSummaryTags: "Summary tags",
    reportRoleTops: "Tops",
    reportRoleBottoms: "Bottoms",
    reportRoleShoes: "Shoes",
    reportRoleLayers: "Layers",
    reportRoleDresses: "Dresses",
    reportRoleAccessories: "Accessories",
    reportMissingCategories: "Missing categories",
    reportWeakCategories: "Weak categories",
    reportOverrepresentedCategories: "Overrepresented categories",
    reportSupportedFormulaTypes: "Supported outfit formulas",
    reportEstimatedOutfitRange: "Estimated outfit range",
    reportEstimatedOutfitRangeValue:
      "{min}-{max} outfits, {confidence} confidence",
    reportMainBlockers: "Main blockers",
    reportMixAndMatchScore: "Mix-and-match score",
    reportRepeatabilityScore: "Repeatability score",
    reportOutfitVariety: "Outfit variety",
    reportPrimaryUseModes: "Primary use modes",
    reportLimitingFactors: "Limiting factors",
    reportPrimaryStyles: "Primary styles",
    reportStyleCluster: "Style cluster",
    reportFragmentation: "Fragmentation",
    reportItemCount: "{count} items",
    reportSeasonSpring: "Spring",
    reportSeasonSummer: "Summer",
    reportSeasonAutumn: "Autumn",
    reportSeasonWinter: "Winter",
    reportPrimarySeasons: "Primary seasons",
    reportWeakSeasons: "Weak seasons",
    reportTemperatureBand: "Temperature band",
    reportTemperatureRange: "{min}–{max}°C",
    reportTemperatureFrom: "from {min}°C",
    reportTemperatureUpTo: "up to {max}°C",
    reportLayeringSupport: "Layering support",
    reportWeatherSuitability: "Weather suitability",
    reportWeatherLimitations: "Weather limitations",
    reportPaletteType: "Palette type",
    reportBaseColors: "Base colors",
    reportAccentColors: "Accent colors",
    reportContrastLevel: "Contrast level",
    reportHarmony: "Harmony",
    reportColorGaps: "Color gaps",
    reportColorRisks: "Color risks",
    reportRedundancyLevel: "Redundancy level",
    reportOrphanItemRisk: "Orphan item risk",
    reportNotableRedundancies: "Notable redundancies",
    reportPotentialOrphans: "Potential orphans",
    reportUnderusedStrengths: "Underused strengths",
    reportExpectedImpact: "Expected impact",
    reportTargetCategory: "Target category",
    reportReplacementCategory: "Replacement category",
    reportReplacementDescription: "Replacement description",
    reportLowConfidenceAspects: "Low confidence aspects",
    reportAssumptions: "Assumptions",
    reportRelatedItems: "Items:",
    reportUnnamedItem: "Item {id}",
    reportVerdict: {
      excellent: "Excellent Personal items set",
      good: "Good Personal items set",
      usable_with_gaps: "Usable with gaps",
  ...
  search: {
    ...
    filters: {
      ...
      max: "Max",
      category: "Category",
      exactColor: "Color match",
      exactColorChip: "Color match: {color} · {range}",
      exactColorToggle: "Enable color matching",
      exactColorHint: "Find items with a similar visible shade.",
      exactColorPicker: "Choose a shade",
      exactColorHex: "HEX color",
      exactColorInvalid: "Use a 6-digit HEX value, for example #808080.",
      exactColorRange: "Match range",
      exactColorRangeAria: "Color match range",
      exactColorRangeValue: "{value} color match range",
      exactColorRangeCloser: "Closer",
      exactColorRangeClosest: "Closest",
      exactColorRangeClose: "Close",
      exactColorRangeBalanced: "Balanced",
      exactColorRangeBroad: "Broad",
      exactColorRangeBroadest: "Broadest",
      exactColorRangeBroader: "Broader",
      exactColorRangeHint: "Broader range includes more color variations.",
  ...
  errors: {
    ...
    capsuleReportGenerateFailed: "Could not generate capsule report.",
