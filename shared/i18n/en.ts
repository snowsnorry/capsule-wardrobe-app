...
const en = {
  ...
  capsule: {
    ...
    sourceMode: {
      ...
      wardrobePreferred: "Wardrobe + catalog",
      wardrobeOnly: "Wardrobe only",
      checkingWardrobe: "Checking Wardrobe items...",
      emptyWardrobe:
        "Wardrobe has no ready items yet. Add items before using this source.",
      loadFailed: "Could not check Wardrobe items.",
    ...
    anchors: {
      ...
      type: "Type:",
      typesAll: "All",
      empty: "No wardrobe items found.",
      unnamed: "{id}",
      remove: "Remove {name}",
      loadFailed: "Failed to load wardrobe items.",
      sources: {
        all: "All",
        uploaded: "Uploaded",
        catalog: "Catalog",
  ...
  wardrobe: {
    ...
    openMenu: "Open Wardrobe menu",
    filterLabel: "Wardrobe source",
    loadFailed: "Failed to load Wardrobe.",
    downloadFailed: "Failed to export Wardrobe PDF. Please try again.",
    uploadFailed: "Failed to upload wardrobe photos. Please try again.",
    urlUploadFailed: "Failed to upload product URLs. Please try again.",
    saved: "Saved to Wardrobe.",
    removed: "Removed from Wardrobe.",
    updated: "Wardrobe item updated.",
    savedBadge: "Saved",
    failedUploadBadge: "Failed",
    noCategoryBadge: "No category",
    needsReviewBadge: "Needs review",
    saveFailed: "Failed to save to Wardrobe. Please try again.",
    saveNotFound: "This product is no longer available in the catalog.",
    removeFailed: "Failed to remove from Wardrobe. Please try again.",
    ...
    removeConfirmBody:
      "This product will be removed from Wardrobe. You can save it again later.",
    ...
    urlUploadDialog: {
      ...
      body: "Add links to commercial product images where the item is clearly visible and laid flat. Each accepted image becomes an uploaded wardrobe item.",
