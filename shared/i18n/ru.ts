...
const ru = {
  ...
  myWardrobe: {
    ...
    urlUploadDialog: {
      title: "Загрузить URL товаров",
      body: "Добавьте ссылки на страницы товаров из онлайн-магазинов. Каждый подходящий товар станет загруженной вещью в гардеробе.",
      fieldLabel: "URL товара {index}",
      placeholder: "https://shop.example.com/product",
      helperText:
        "Используйте URL страницы товара, начинающийся с http:// или https://.",
